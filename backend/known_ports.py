...
KNOWN_PORTS: dict[int, dict] = {
    ...
    51821: {"name": "wg-easy",       "description": "wg-easy web UI",                                "category": "vpn",       "is_access_port": True},
    ...
    5006: {"name": "Actual",       "description": "Actual Budget",                                  "category": "selfhosted","is_access_port": True},
    5678: {"name": "n8n",          "description": "n8n workflow automation",                        "category": "selfhosted","is_access_port": True},
    ...
    8006: {"name": "Proxmox",      "description": "Proxmox VE web UI",                               "category": "infra",     "is_access_port": True},
    ...
    8083:   {"name": "Calibre-Web",  "description": "Calibre-Web",                                   "category": "selfhosted","is_access_port": True},
    8091:   {"name": "Z-Wave JS UI", "description": "Z-Wave JS UI",                                  "category": "selfhosted","is_access_port": True},
    ...
    8581:   {"name": "Homebridge",   "description": "Homebridge UI",                                 "category": "selfhosted","is_access_port": True},
    ...
    5380:   {"name": "Technitium",   "description": "Technitium DNS web UI",                         "category": "selfhosted","is_access_port": True},
    ...
    8971:   {"name": "Frigate",      "description": "Frigate NVR web UI",                            "category": "selfhosted","is_access_port": True},
    ...
    25600:  {"name": "Komga",        "description": "Komga comics / manga",                          "category": "selfhosted","is_access_port": True},
    ...
    9091:   {"name": "Transmission", "description": "Transmission web UI (also Prometheus Pushgateway)", "category": "selfhosted","is_access_port": True},
