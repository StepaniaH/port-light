...
import { S, saveView } from './state.js?v=96';
import { t, tx, escapeHtml, safeHref, errorText } from './text.js?v=96';
import { appEl, detailPanel, detailBackdrop, detailContent, unhideBtn, syncHeaderHeight } from './dom.js?v=96';
import { trapTab } from './a11y.js?v=96';
import { api } from './api.js?v=96';
import { portApiUrl, hasPeers, hostName, gridHash, dataForHost } from './hosts.js?v=96';
import { isLease, remainingSeconds, fmtRemaining } from './leases.js?v=96';
import {
...
import { closeModals, modalOpen, openModal } from './modal.js?v=96';
